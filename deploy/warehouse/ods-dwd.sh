...
dwd_interaction_comment_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_interaction_comment_inc partition(dt = '${do_date}')
        select id,
               user_id,
               sku_id,
               order_id,
...
dwd_interaction_favor_add_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_interaction_favor_add_inc partition(dt = '${do_date}')
        select data.id,
               data.user_id,
               data.sku_id,
...
dwd_tool_coupon_get_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_tool_coupon_get_inc partition (dt = '${do_date}')
        select data.id,
               data.coupon_id,
               data.user_id,
...
dwd_tool_coupon_order_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_tool_coupon_order_inc partition(dt = '${do_date}')
        select data.id,
               data.coupon_id,
               data.user_id,
               data.order_id,
               ...
               data.using_time
        from ${HIVE_DATA_BASE}.ods_coupon_use_inc
        where dt = '${do_date}' and type = 'update' and array_contains(map_keys(old), 'using_time');
    "

dwd_tool_coupon_pay_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_tool_coupon_pay_inc partition(dt = '${do_date}')
        select data.id,
               data.coupon_id,
               data.user_id,
               data.order_id,
               ...
               data.used_time
        from ${HIVE_DATA_BASE}.ods_coupon_use_inc
        where dt = '${do_date}' and type = 'update' and array_contains(map_keys(old),'used_time');
    "

dwd_trade_cancel_detail_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_trade_cancel_detail_inc partition (dt = '${do_date}')
        select od.id,
               order_id,
               user_id,
               sku_id,
        ...
        (
            ...
            where (dt = '${do_date}' or dt = date_add('${do_date}',-1)) and (type = 'insert' or type = 'bootstrap-insert')
        ) od join
        (
            select data.id,
                   data.user_id,
            ...
            where dt = '${do_date}' and type = 'update' and data.order_status = '1003' and array_contains(map_keys(old),'order_status')
...
dwd_trade_cart_add_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_trade_cart_add_inc partition(dt = '${do_date}')
        select id,
               user_id,
               sku_id,
               date_id,
...
dwd_trade_order_detail_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_trade_order_detail_inc partition (dt = '${do_date}')
        select od.id,
               order_id,
               user_id,
               sku_id,
...
dwd_trade_order_refund_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_trade_order_refund_inc partition(dt = '${do_date}')
        select ri.id,
               user_id,
               order_id,
               sku_id,
        ...
        (
            select data.id,
                   data.province_id
            from ${HIVE_DATA_BASE}.ods_order_info_inc
            where dt = '${do_date}' and type = 'update' and data.order_status = '1005' and array_contains(map_keys(old),'order_status')
    ...
    insert overwrite table ${HIVE_DATA_BASE}.dwd_trade_pay_detail_suc_inc partition (dt = '${do_date}')
        select od.id,
               od.order_id,
               user_id,
               sku_id,
        ...
        (
            ...
            where dt = '${do_date}' and type = 'update' and array_contains(map_keys(old),'payment_status') and data.payment_status = '1602'
...
dwd_trade_refund_pay_suc_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_trade_refund_pay_suc_inc partition(dt = '${do_date}')
        select rp.id,
               user_id,
               rp.order_id,
               rp.sku_id,
        ...
        (
            ...
            where dt = '${do_date}' and type = 'update' and array_contains(map_keys(old),'refund_status') and data.refund_status = '1602'
        ) rp left join 
        (
            select data.id,
                   data.user_id,
                   data.province_id
            from ${HIVE_DATA_BASE}.ods_order_info_inc
            where dt = '${do_date}' and type = 'update' and data.order_status = '1006' and array_contains(map_keys(old),'order_status')
        ...
        (
            select data.order_id,
                ...
                data.refund_num
            from ${HIVE_DATA_BASE}.ods_order_refund_info_inc
            where dt = '${do_date}' and type = 'update' and data.refund_status = '0705' and array_contains(map_keys(old),'refund_status')
...
dwd_user_register_inc="
    insert overwrite table ${HIVE_DATA_BASE}.dwd_user_register_inc partition(dt = '${do_date}')
        select ui.user_id,
               date_format(create_time,'yyyy-MM-dd') date_id,
               create_time,
               channel,
