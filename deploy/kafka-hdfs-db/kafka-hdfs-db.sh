...
function service_start()
{
    ...
    # 替换缓存数据检查点
    sed -i "s#a3.channels.c3.dataDirs.*#a3.channels.c3.dataDirs = ${SERVICE_DIR}/db-cache/#g" "${SERVICE_DIR}/${CONF_FILE}"
    sed -i "s#a3.channels.c3.checkpointDir.*#a3.channels.c3.checkpointDir = ${SERVICE_DIR}/db-cp/#g" "${SERVICE_DIR}/${CONF_FILE}"
